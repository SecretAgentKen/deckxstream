...
module.exports = class ButtonController {
	...
	activate() {
		if (Object.prototype.hasOwnProperty.call(this.btnCfg,'change_brightness')) {
			this.deckMgr.setBrightness(this.btnCfg.change_brightness);
		}
		...
		if (Object.prototype.hasOwnProperty.call(this.btnCfg,'change_page')) {
